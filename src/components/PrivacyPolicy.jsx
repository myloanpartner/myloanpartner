            ...
            <div className="container">
                ...
                >
                    ...
                    <ul>
                        ...
                        <li>
                            <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to My Loan Partner.</p>
                        </li>
                        <li>
                        ...
                        <li>
                            <p><strong>Website</strong> refers to My Loan Partner, accessible from <a href="https://myloanpartner.in/" rel="external nofollow noopener noreferrer" target="_blank">https://myloanpartner.in/</a></p>
                        </li>
                        <li>
